      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[1.7fr_1fr]">
          <div>
            ...
            <dl className="mt-8 grid grid-cols-3 gap-4 border-y border-sand py-6 sm:max-w-md">
              <div>
            ...
            <p className="mt-8 max-w-2xl leading-relaxed text-ink/80">{property.description}</p>

            <ul className="mt-8 grid grid-cols-2 gap-x-6 gap-y-2 sm:max-w-md">
          ...
          {/* Agent card */}
          <aside className="h-fit rounded-xl border border-sand bg-white p-6">
        ...
        {related.length > 0 && (
          <section className="mt-20 border-t border-sand py-16">
            <h2 className="font-serif text-2xl text-ink">Otras propiedades en {property.barrio}</h2>
